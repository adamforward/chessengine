...
# Define the model with three conv layers, then pooling, followed by two conv layers
...
class ChessCNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(256 * 2 * 2, 128)  # Adjusted for output size
...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs=20):
    ...
    final_model_path = '/content/drive/My Drive/chess_cnn_model_final_3xpool2xconv_f32.pt'
    torch.save(model.state_dict(), final_model_path)
    print("Final model saved successfully")

    # Convert the final model to float16
    model.half()
    final_model_path_f16 = '/content/drive/My Drive/chess_cnn_model_final_3xpool2xconv_f16.pt'
